...
class EWNTYoutube_RSSTestCase(unittest.TestCase):
    ...
    def test_parse_entry(self):
        ...
        self.assertEqual(
            "tag:i3.ytimg.com:vi:2JELmDmKJlA:hqdefault.jpg", featured["guid"]
        )
        # self.assertIn('Credit: Christine Rousselle/CNA', featured['description_text'])
        self.assertEqual(
            "THE CATHOLIC UNIVERSITY OF AMERICA: MASS OF THE HOLY SPIRIT - 2023-08-31",
            featured["headline"],
        )
        ...
        self.assertEqual(
            "https://i3.ytimg.com/vi/2JELmDmKJlA/hqdefault.jpg", rend["href"]
        )
